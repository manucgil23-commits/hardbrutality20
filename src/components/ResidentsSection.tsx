...
const residents: DJ[] = [
  {
    ...
    image: djMixxi,
    role: "RESIDENT DJ",
    shortBio: "Sets machacones fusionando lo sexy, metalero y punky.",
  ...
  },
  {
    ...
    image: djRods,
    role: "RESIDENT DJ",
    shortBio: "Seis años fusionando Hardgroove con Hardbounce.",
  ...
  },
  {
    ...
    image: djSame,
    role: "RESIDENT DJ",
    shortBio: "Sintetizadores ácidos, BPMs vertiginosos y rave.",
  ...
  },
  {
    ...
    image: djKoni,
    role: "RESIDENT DJ",
    shortBio: "Hardbounce con ritmos rápidos que prohíben parar.",
